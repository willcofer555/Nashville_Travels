...
db.serialize(() => {
    ...
    db.run('CREATE TABLE Users (id INTEGER PRIMARY KEY, Last_Name TEXT NOT NULL, First_Name TEXT NOT NULL, Email TEXT NOT NULL, Password TEXT, City TEXT NOT NULL, State TEXT NOT NULL, Zipcode INTEGER NOT NULL)', (err,rows) => {
        if (err) {
            console.log(err);
    ...
    db.run("INSERT INTO Users (Last_Name, First_Name, Email, Password, City, State, Zipcode) VALUES ('Doe', 'John', 'Johndoe@gmail.com', 'testpassword', 'Franklin', 'Tennessee', '37064')", (err,rows) => {
        if (err) {
            console.log(err)
